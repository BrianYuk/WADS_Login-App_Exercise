    ...
    paths: {
      "/api/session": {
        post: {
          ...
          description: "Verifies the Firebase ID token (Bearer), then sets an httpOnly session cookie.",
      ...
      "/api/auth/firebase": {
        post: {
          ...
          description: "Verifies Firebase ID token, creates or updates the user in the database, and sets the session cookie.",
      ...
      "/api/auth/{path}": {
        get: {
          ...
          description: "Better Auth catch-all GET handler (e.g. get-session).",
          ...
          parameters: [
            {
              ...
              required: true,
              schema: { type: "string" },
              description: "Better Auth path segment, e.g. get-session",
            },
          ],
          responses: {
        ...
        post: {
          ...
          description: "Better Auth catch-all POST handler (sign-in/email, sign-up/email, sign-out, etc).",
          ...
          parameters: [
            {
              ...
              required: true,
              schema: { type: "string" },
              description: "Better Auth path, e.g. sign-in/email, sign-up/email",
            },
          ],
          requestBody: {
            content: {
      ...
      "/api/todos/{id}": {
        patch: {
          tags: ["Todos"],
          summary: "Update todo",
          description: "Updates an existing todo by id. Only the owner can update.",
        ...
        delete: {
          tags: ["Todos"],
          summary: "Delete todo",
          description: "Deletes a todo by id. Only the owner can delete.",
